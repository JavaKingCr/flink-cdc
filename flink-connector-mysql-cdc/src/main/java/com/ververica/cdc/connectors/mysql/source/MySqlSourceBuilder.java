...
public class MySqlSourceBuilder<T> {
    ...
    /**
     *
     * @param supportMysqlPrimaryKey
     * @return
     */
    public MySqlSourceBuilder<T> supportNoMysqlPrimaryKey(Boolean supportMysqlPrimaryKey) {
        this.configFactory.supportMysqlPrimaryKey(supportMysqlPrimaryKey);
        return this;
    }
