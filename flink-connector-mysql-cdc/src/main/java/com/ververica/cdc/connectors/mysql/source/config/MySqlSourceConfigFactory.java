...
public class MySqlSourceConfigFactory implements Serializable {
    ...
    private Boolean supportMysqlPrimaryKey=false;
    ...
    public MySqlSourceConfigFactory supportMysqlPrimaryKey(Boolean supportMysqlPrimaryKey) {
        this.supportMysqlPrimaryKey = supportMysqlPrimaryKey;
        return this;
    }
    ...
    public MySqlSourceConfig createConfig(int subtaskId) {
        ...
        return new MySqlSourceConfig(
                ...
                props,
                jdbcProperties,
                chunkKeyColumn,supportMysqlPrimaryKey);
    }
}
